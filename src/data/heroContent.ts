...
export const heroContent = {
    ...
    intro:
        'Sono uno sviluppatore backend con una forte spinta verso il full stack. Mi piacciono i sistemi ben pensati, l estetica fatta bene e tutto cio che mi fa salire di livello.',
    ctas: {
    ...
    hud: {
        ...
        status: 'Leveling up',
        stats: [
            {label: 'Backend_Stability', value: 80, colorClass: 'is-green'},
            {label: 'Frontend_Polish', value: 60, colorClass: 'is-mint'},
            {label: 'Discipline_Stat', value: 75, colorClass: 'is-soft'},
            {label: 'Curiosity_Engine', value: 85, colorClass: 'is-orange'},
        ] as HeroStat[],
        quests: [
